...
st.markdown(
    ...
    <p style='text-align: center; font-size:16px; margin-bottom:40px;'>
        ...
        This project is an exercise to practice Python data manipulation
        while providing useful insights on daily market information.
    </p>
    """,
...
# --- First section title (normal Streamlit header) ---
st.header("Main Market Dashboard")
